...
const ELECTRONICS: ScenePreset = {
  ...
  chatMessages: [
    ...
    { from: "ai", text: "⚠ AOI 불량률: 2.8% (기준 0.5%)\n주요 불량: 솔더 브릿지 62%, 툼스톤 23%\n원인 추정: 리플로우 Zone3 온도 +8°C 편차", alert: true, at: 0.5 },
  ...
  overlayTexts: [
    ...
    { title: "AOI 불량률 급증! 2.8%", subtitle: "솔더 브릿지 62% · 리플로우 Zone3 온도 편차" },
