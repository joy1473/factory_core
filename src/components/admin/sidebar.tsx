  ...
  return (
    <aside className="flex w-56 shrink-0 flex-col border-r border-[var(--border)] bg-[var(--surface)]">
      ...
      <div className="flex h-16 items-center gap-2 border-b border-[var(--border)] px-5">
        <div className="flex h-7 w-7 items-center justify-center rounded-md bg-gradient-to-br from-[#00ff41] to-[var(--primary)] text-[10px] font-black text-black">
          FC
        </div>
        <span className="text-sm font-bold text-[#00ff41]">Admin</span>
      </div>
      ...
      <div className="border-t border-[var(--border)] p-3">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-400 transition hover:bg-white/5 hover:text-red-400"
        >
          <LogOut size={18} />
          로그아웃
        </button>
