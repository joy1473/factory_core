...
const PAIN_POINTS = [
  { icon: Users, value: "50.4%", label: "전문인력 부족", desc: "데이터 수집·분석 담당자 없음", color: "var(--danger)" },
  { icon: DollarSign, value: "44.2%", label: "초기 비용 부담", desc: "스마트공장 평균 도입 비용 7.5억원", color: "var(--accent)" },
  { icon: AlertTriangle, value: "43.8%", label: "운영 인력 부족", desc: "전담 부서 보유 기업 19.5%뿐", color: "#ff6644" },
  { icon: Database, value: "60.8%", label: "데이터는 수집하지만", desc: "AI로 활용하는 기업은 0.1%", color: "var(--primary)" },
  ...
  return (
    <section className="border-t border-[var(--border)] bg-[var(--surface)]">
      <div className="mx-auto max-w-6xl px-5 py-20">
        <p className="mb-2 text-center text-xs font-semibold uppercase tracking-widest text-[var(--danger)]">
          Pain Points
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {PAIN_POINTS.map((p) => (
            ...
            >
              ...
              <h3 className="mb-1 text-sm font-bold text-[var(--foreground)]">{p.label}</h3>
